...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{URL::to('/welcome-seller') }}" class="brand-link">
            <span style="text-align: center">Trang dành cho người bán</span>
        </a>
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                $seller = DB::table('users')
                    ->where('id_user',Session::get('id_seller'))->get()->first();
                ?>
                <div class="image">
                    <img src="{{$seller->avatar}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="{{ URL::to('/change-seller-information') }}" class="d-block">{{$seller->name_user}}</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{URL::to('/seller-all-news')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{URL::to('/change-seller-information')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{URL::to('/seller-multimedia-management')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Quản lý multimedia</p>
                                </a>
                            </li>
