                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <a style="color: rebeccapurple"
                                           href="{{URL::to('/news-detail-'.$eachUserComment->id_news) }}">
                                            {{ $eachNews->title }}
                                        </a>
                                    </td>
                                    <td style="text-align: center">
                                    ...
                                    <td>
                                        @if($eachUserComment->is_valid_coment == 1)
                                            <p style="color: green">Bình luận hiển thị</p>
                                            <a style="color: #e63084"
                                               href="{{URL::to('/admin-delete-comment/'.$eachUserComment->id_coment)}}">Ẩn
                                                bình luận</a>
                                        @else   <!--($eachUserComment->is_valid_coment == 0)-->
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('/admin-unblock-user/'.$writer->id_user)}}">Mở Khóa tài khoản</a>
                                        <?php
                                        }else{ //if($writer->status_user == 1){ // active
                                        ?>
                                        <p style="color: green">Đang hoạt động</p>
                                        <a href="{{URL::to('/admin-block-user/'.$writer->id_user)}}">Khóa tài khoản</a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                            ...
                            @foreach($allUserReply as $eachUserReply)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        ?>
                                        <a style="color: rebeccapurple"
                                           href="{{URL::to('/news-detail-'.$eachUserReply->id_news) }}">
                                            {{ $eachNews->title }}
                                        </a>
                                    </td>
                                    <td style="text-align: center">
                                    ...
                                    <td>
                                        @if($eachUserReply->is_valid_reply == 1)
                                            <p style="color: green">Phản hồi hiển thị</p>
                                            <a style="color: #e63084"
                                               href="{{URL::to('/admin-delete-reply/'.$eachUserReply->id_reply)}}">Ẩn
                                                phản hồi</a>
                                        @else   <!--($eachUserReply->is_valid_reply == 0)-->
